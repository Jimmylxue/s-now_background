...
/// <reference types="/Users/mac/Desktop/code/background/snow-background/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "/Users/mac/Desktop/code/background/snow-background/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const formatMessage = undefined;
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || '@snow-program/background'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
