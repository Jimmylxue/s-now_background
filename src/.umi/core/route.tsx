...
export async function getRoutes() {
  const routes = {"1":{"path":"/user","layout":false,"id":"1"},"2":{"name":"登录","path":"/user/login","parentId":"1","id":"2"},"3":{"path":"/welcome","name":"欢迎","icon":"smile","parentId":"ant-design-pro-layout","id":"3"},"4":{"path":"/admin","name":"管理页","icon":"crown","parentId":"ant-design-pro-layout","id":"4"},"5":{"path":"/admin","redirect":"/admin/sub-page","parentId":"4","id":"5"},"6":{"path":"/admin/sub-page","name":"二级管理页","parentId":"4","id":"6"},"7":{"path":"/manage","name":"系统管理","icon":"crown","parentId":"ant-design-pro-layout","id":"7"},"8":{"path":"/manage","redirect":"/admin/letter","parentId":"7","id":"8"},"9":{"path":"/manage/letter","name":"站内信","hideChildrenInMenu":true,"parentId":"7","id":"9"},"10":{"path":"/member","name":"会员管理","icon":"crown","parentId":"ant-design-pro-layout","id":"10"},"11":{"name":"查询表格","icon":"table","path":"/list","parentId":"ant-design-pro-layout","id":"11"},"12":{"path":"/","redirect":"/welcome","parentId":"ant-design-pro-layout","id":"12"},"13":{"path":"*","layout":false,"id":"13"},"ant-design-pro-layout":{"id":"ant-design-pro-layout","path":"/","isLayout":true},"umi/plugin/openapi":{"path":"/umi/plugin/openapi","id":"umi/plugin/openapi"}} as const;
  return {
    routes,
    routeComponents: {
